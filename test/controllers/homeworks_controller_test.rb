...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { actual_phase: @homework.actual_phase, name: @homework.name, upload: @homework.upload }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { actual_phase: @homework.actual_phase, name: @homework.name, upload: @homework.upload  }
    assert_redirected_to homework_path(assigns(:homework))
  end
